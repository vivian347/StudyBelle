...
import com.example.study.util.Constants.NOTIFICATION_CHANNEL_ID
import com.example.study.util.Constants.NOTIFICATION_CHANNEL_NAME
import com.example.study.util.Constants.NOTIFICATION_ID
import com.example.study.util.pad
...
class StudySessionTimerService: Service() {
    ...
    var subjectId: MutableState<Int?> = mutableStateOf<Int?>(null)
