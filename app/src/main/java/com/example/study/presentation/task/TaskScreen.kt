...
import com.example.study.presentation.components.TaskCheckBox
import com.example.study.presentation.components.TaskDatePicker
import com.example.study.util.Priority
import com.example.study.util.SnackbarEvent
import com.example.study.util.changeMillisToDateString
...
private fun TaskScreen(
    ...
    taskTitleError = when {
        state.title.isBlank() -> "Enter task title"
    ...
    Scaffold(
        ...
        topBar = {
            TaskScreenTopBar(
                taskExist = state.currentTaskId != null,
                isComplete = state.isTaskComplete,
                checkBoxBorderColor = state.priority.color,
                onBackButtonClick = onBackButtonClick,
                onDeleteButtonClick = { isDeleteDialogOpen = true },
                onCheckBoxClick = { onEvent(TaskEvent.OnIsTaskCompleteChange) }
            )
        }
    ) {paddingValue ->
        Column(
